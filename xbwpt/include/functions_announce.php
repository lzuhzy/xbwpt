...
//	if (!$agent="uTorrent/300B");{
//	$fp=fopen("1.txt","a");
//	fwrite($fp,"peer_id= ".$peer_id."||agent= ".$agent."||agent_familyid= ".$agent_familyid."\n");
//		}
//	$ary_tem=$clients;
//	$fp=fopen("1.txt","a");
//	fwrite($fp,var_export($ary_tem,true));
...
//	if ($agent="uTorrent/2040")
//	{	
//		$fp = fopen("1.txt","a");
//		fwrite($fp,$allowed_flag_peer_id."||".$allowed_flag_agent."||".$version_low_peer_id."||".$version_low_agent);
//	}
}
?>
