...
define('ADMIN_PASSWORD','ptadmin');  	// Admin Password
...
<div class="head">
	<h1 class="memcache">
		...
		<span class="nameinfo">监控程序作者: <a href="http://livebookmark.net">Harun Yayli</a></span>
		<span class="nameinfo">简体中文支持: <a href="http://www.xnlinux.cn">XNLINUX</a></span>
	</h1>
	<hr class="memcache">
</div>
<div class=content>
...
if ($_GET['op']!=4){
echo <<<EOB
    <li><a href="$PHP_SELF&op={$_GET['op']}">刷新数据信息</a></li>
EOB;
}
else {
echo <<<EOB
