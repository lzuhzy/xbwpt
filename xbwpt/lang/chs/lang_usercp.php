...
(
	...
	'text_saved' => "已保存！",
	'row_account_parked' => "自杀账号",
	'checkbox_pack_my_account' => "我将长期不使用账号。",
	'text_account_pack_note' => "<b>注意：</b>自杀帐号请到西北望，所有西北望的用户将自动同步到此站",
	'row_pms' => "短讯",
	...
	'text_isp' => "互联网服务提供商",
	'text_show_searchbox' => "种子分类",
	'text_show_searchbox_description' => "种子分类默认展开",
