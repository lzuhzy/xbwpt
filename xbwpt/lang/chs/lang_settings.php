...
(
	...
	'text_ten_gb_credit_note' => "个魔力值，如果他选择交换10.0 GB上传量。默认'1300'。",
	'row_fifty_gb_credit' => "50.0 GB上传量",
	'text_fifty_gb_credit_note' => "个魔力值，如果他选择交换50.0 GB上传量。默认'7000'。",
	'row_onehundred_gb_credit' => "100.0 GB上传量",
	'text_onehundred_gb_credit_note' => "个魔力值，如果他选择交换100.0 GB上传量。默认'10300'。",
	...
	'text_initial_seedbonus_amount_note' => "单位为个。新注册用户的初始魔力值。默认'0'。",
	...
	'row_enable_loginadd' => "开启登录奖励",
	'row_allow_loginadd' => "若开启，则登录时会自动奖励魔力值。默认'是'。",
