...
(
	...
	'text_ten_gb_credit_note' => "個魔力值，如果他選取交換10.0 GB上傳量。預設'1300'。",
	'row_fifty_gb_credit' => "50.0 GB上傳量",
	'text_fifty_gb_credit_note' => "個魔力值，如果他選取交換100.0 GB上傳量。預設'7000'。",
	'row_onehundred_gb_credit' => "100.0 GB上傳量",
	'text_onehundred_gb_credit_note' => "個魔力值，如果他選取交換100.0 GB上傳量。預設'10300'。",
	...
	'row_initial_seedbonus_amount' => "初始魔力值",
	'text_initial_seedbonus_amount_note' => "單位為個。新註冊用戶的初始魔力值。默認'0'。",
	...
	'text_invite_timeout_note' => "單位為天。邀請碼如在發出X天后仍未使用，將被移除。預設'7'。",
        'row_enable_loginadd' => "開啟登錄獎勵",
        'row_allow_loginadd' => "若開啟，則登錄時會自動獎勵魔力值。默認'是'。",
