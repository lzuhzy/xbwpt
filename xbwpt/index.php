...
require "./memcache.php"; //Amanda add 2012-1-3
dbconn(true);
...
<script type="text/javascript">
	alert('连续登录<?php echo $salarynum; ?>天奖励，恭喜你获取了<?php echo $addbonus; ?>点魔力值，继续保持哦');
</script>
<?php
}else if($Days > 0){
...
?>
<script type="text/javascript">
	alert('每日登录奖励，恭喜你获取了<?php echo $addbonus; ?>点魔力值，连续多天登录会有更多奖励哦');
</script>
<?php
		}
	}
