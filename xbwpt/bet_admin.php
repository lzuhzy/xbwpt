...
<tr><td>条件</td><td><input type='text' name='undertext' size='50' value='投注结果不含加时赛及点球大战' /></td></tr>
<tr>
<tr><td>选项(,)</td><td><input type='text' name='text' size='50' value='中国胜,平局,德国胜' /></td></tr>
<tr>
