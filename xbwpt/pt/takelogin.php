...
//openlog("ptlog", LOG_PID | LOG_PERROR, LOG_LOCAL0);
if (!mkglobal("code"))
{
	die();
}
else
{
	...
	if(uc_authcode($code, 'DECODE', PT_KEY, 600)=="")
	  die();
	parse_str(uc_authcode($code, 'DECODE', PT_KEY, 600), $codearray);
...
if ($iv == "yes")
	check_code ($login_imagehash, $login_imagestring,'login.php',true);
