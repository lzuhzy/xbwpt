...
$body = "[b]".($o['heading'])."[/b]\n\n";
$body.= "获胜条件 : [b] ".($o['undertext'])." [/b]\n";
$body.= "下注总数 : [b] ".htmlspecialchars($s[0])." [/b]\n";
$body.= "投注总额 : [b] ".htmlspecialchars($totalstats)." points[/b]\n";
$body.= "获胜选项 : [b] ".($b['text'])." [/b]\n";
$body.= "开盘黑手 : [b] ".get_username($o['creator'],false,false,true,true,false,false, "", false, true)." [/b]\n";
$body.= "开盘时间 : [b] ".htmlspecialchars(date("Y-m-d H:i",$o['startime']))." [/b]\n";
$body.= "结盘黑手 : [b] ".get_username($CURUSER['id'],false,false,true,true,false,false, "", false, true)." [/b]\n";
...
$body .= "[b]+".($k['bonus']+round($k['bonus']*($odds['odds']-1)*0.90,0))." 魔力值[/b],用户 ".get_username($k['id'],false,false,true,true,false,false, "", false, true)." 押注 ".htmlspecialchars($k['bonus'])." 魔力值 \n";
}
...
$body.= "\n[b]Top 20 好人:[/b]\n";
while($k = mysql_fetch_array($m)){
$body .= "[b]-".htmlspecialchars($k['bonus'])." 魔力值[/b],用户 ".get_username($k['id'],false,false,true,true,false,false, "", false, true)." \n";
}
