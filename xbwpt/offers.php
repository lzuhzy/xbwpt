...
if ($_GET["add_offer"]){
	...
	foreach ($cats as $row)
	$s .= "<option value=".$row["id"].">" . htmlspecialchars($row["name" . (get_langfolder_cookie()=='chs'? '_chs':'')]) . "</option>\n";
	$s .= "</select>\n";
